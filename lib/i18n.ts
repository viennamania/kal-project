...
const dictionaries = {
  ko: {
    ...
    wallet: {
      ...
      inviteContactButton: "주소록에서 선택",
      inviteContactFailed: "주소록을 열지 못했습니다. 전화번호를 직접 입력해 주세요.",
      inviteContactHint: "지원되는 모바일 브라우저에서는 주소록에서 전화번호를 바로 고를 수 있습니다.",
      inviteContactMissingPhone: "선택한 연락처에 전화번호가 없습니다.",
      inviteContactPicking: "주소록 여는 중...",
      inviteContactReady: "주소록에서 전화번호를 가져왔습니다.",
      inviteContactUnavailable: "이 브라우저에서는 주소록 선택을 지원하지 않습니다.",
  ...
  en: {
    ...
    wallet: {
      ...
      inviteContactButton: "Pick from contacts",
      inviteContactFailed: "Could not open contacts. Enter the phone number manually.",
      inviteContactHint:
        "On supported mobile browsers, you can choose a phone number directly from contacts.",
      inviteContactMissingPhone: "The selected contact does not have a phone number.",
      inviteContactPicking: "Opening contacts...",
      inviteContactReady: "Phone number imported from contacts.",
      inviteContactUnavailable: "This browser does not support contact picking.",
  ...
  ja: {
    ...
    wallet: {
      ...
      inviteContactButton: "連絡先から選択",
      inviteContactFailed: "連絡先を開けませんでした。電話番号を直接入力してください。",
      inviteContactHint:
        "対応しているモバイルブラウザでは、連絡先から電話番号を直接選べます。",
      inviteContactMissingPhone: "選択した連絡先に電話番号がありません。",
      inviteContactPicking: "連絡先を開いています...",
      inviteContactReady: "連絡先から電話番号を読み込みました。",
      inviteContactUnavailable: "このブラウザは連絡先選択に対応していません。",
  ...
  "zh-CN": {
    ...
    wallet: {
      ...
      inviteContactButton: "从通讯录选择",
      inviteContactFailed: "无法打开通讯录，请手动输入手机号。",
      inviteContactHint: "在支持的移动浏览器中，可以直接从通讯录选择手机号。",
      inviteContactMissingPhone: "所选联系人没有手机号。",
      inviteContactPicking: "正在打开通讯录...",
      inviteContactReady: "已从通讯录读取手机号。",
      inviteContactUnavailable: "当前浏览器不支持通讯录选择。",
